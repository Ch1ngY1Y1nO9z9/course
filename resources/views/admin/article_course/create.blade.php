            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">課程專區管理 － 新增文章</h3>
                    </div>
                    <div class="card-body">
                        <form class="form-horizontal" method="post" action="/micro-course/article_course/store" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select id="type" class="form-control" name="type">
                                        <option value="9">通識課程</option>
                                        <option value="10">微學分課程</option>
                                    </select>
                                </div>
                            </div>
