            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">宣傳品管理</h3>
                    </div>
                    <div class="card-body">
                        <a class="btn btn-success" href="/micro-course/promote/create">新增文章</a>
                        <hr>
                            ...
                            @foreach($lists as $list)
                                <tr>
                                    ...
                                    <td width="170">
                                        ...
                                        @endif
                                        <a class="btn btn-sm btn-success" href="/micro-course/promote/edit/{{$list->id}}">編輯</a>
                                        <button class="btn btn-sm btn-danger" data-listid="{{$list->id}}">刪除</button>
                                        <form class="delete-form" action="/micro-course/promote/delete/{{$list->id}}" method="POST" style="display: none;" data-listid="{{$list->id}}">
                                            {{ csrf_field() }}
                                        </form>
                                    </td>
                                </tr>
