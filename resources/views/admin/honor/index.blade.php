            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">師生榮譽榜管理</h3>
                    </div>
                    <div class="panel-body">
                        <a class="btn btn-success" href="/admin/honor/create">新增文章</a>
                        <hr>
                            ...
                            @foreach($lists as $list)
                                <tr>
                                    ...
                                    <td width="170">
                                        ...
                                        @endif
                                        <a class="btn btn-sm btn-success" href="/admin/honor/edit/{{$list->id}}">編輯</a>
                                        <button class="btn btn-sm btn-danger" data-listid="{{$list->id}}">刪除</button>
                                        <form class="delete-form" action="/admin/honor/delete/{{$list->id}}" method="POST" style="display: none;" data-listid="{{$list->id}}">
                                            {{ csrf_field() }}
                                        </form>
                                    </td>
                                </tr>
