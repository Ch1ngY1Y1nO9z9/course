            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">下載專區管理 － 新增文章</h3>
                    </div>
                    <div class="card-body">
                        <form class="form-horizontal" method="post" action="/micro-course/download/store" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select id="plan_type" class="form-control" name="plan_type">
                                        <option value="辦公室辦法">辦公室辦法</option>
                                        <option value="委員會辦法">委員會辦法</option>
                                        <option value="相關表單">相關表單</option>
                                    </select>
                                </div>
                            </div>
