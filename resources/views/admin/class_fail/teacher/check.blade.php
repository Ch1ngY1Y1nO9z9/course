                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="slider_a_href" name="slider_a_href" value="微積分" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="slider_a_href" name="slider_a_href" value="Calculus " readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="datetime-local" class="form-control" id="slider_a_href" name="slider_a_href" value="2021-07-24T08:00" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="datetime-local" class="form-control" id="slider_a_href" name="slider_a_href" value="2021-07-29T12:00" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="datetime-local" class="form-control" id="slider_a_href" name="slider_a_href" value="2021-06-29T17:00" readonly>
                            </div>
                        </div>
